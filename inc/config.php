...
define('SystemDomain','www.lidongyu.cn');//网站域名 多个域名用;分隔
...
define('TableEx','blog_');//表名前缀
define('ArticleTable',TableEx.'article');//默认文章表
define('SiteHash','13569d43d436732134c4');//站点随机码,防止冲突
...
$site_db=array('database'=>'mysqlpdo','host'=>'127.0.0.1','dbname'=>'blog','user'=>'root','password'=>'123123');
